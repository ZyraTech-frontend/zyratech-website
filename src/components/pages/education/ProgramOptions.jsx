...
const professionalCourses = [
  {
    ...
    description: 'Learn HTML, CSS, React, and Tailwind CSS to build responsive websites and web applications.',
    image: '/images/image1.png',
    price: 350,
    link: '/services/education/program-details?program=web-development',
    id: 'web-development'
  },
  {
    icon: Cpu,
    title: 'AI & Robotics',
    description: 'Master artificial intelligence and robotics fundamentals through hands-on projects and real-world applications.',
    image: '/images/image2.png',
    price: 350,
    link: '/services/education/program-details?program=ai-robotics',
    id: 'ai-robotics'
  },
  {
    icon: Terminal,
    title: 'Networking & IT Setup',
    description: 'Learn LAN/WAN installation, WiFi setup, server deployment, and cloud fundamentals for IT infrastructure.',
    image: '/images/image3.png',
    price: 350,
    link: '/services/education/program-details?program=networking-it',
    id: 'networking-it'
  }
];
