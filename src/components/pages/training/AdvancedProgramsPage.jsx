          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-12"
              >
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Your Expert Learning Experience</h3>
                <p className="text-gray-600">Our advanced programs are designed for technology leaders. Engage in cutting-edge research, strategic thinking, and innovation projects.</p>
              </motion.div>
          ...
          <section className="py-16 bg-gradient-to-br from-[#004fa2] to-[#2A2D7C]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-12"
              >
                <h3 className="text-5xl font-black text-yellow-300 mb-8 drop-shadow-lg leading-tight">Your Expert Journey</h3>
                <p className="text-yellow-100 text-xl font-semibold drop-shadow leading-relaxed">From technology leader to industry pioneer</p>
              </motion.div>
