    ...
    <section id="training-about" className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mt-6 mb-16">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Industry-Relevant Curriculum</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Hands-On Learning</h4>
                    <p className="text-gray-600 leading-relaxed">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mt-10">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Experienced Mentors</h4>
                    <p className="text-gray-600 leading-relaxed">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Inclusive Learning Environment</h4>
                    <p className="text-gray-600 leading-relaxed">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Committed to Social Impact</h4>
                    <p className="text-gray-600 leading-relaxed">
        ...
        >
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-shrink-0">
              <div className="w-20 h-20 bg-[#004fa2] rounded-full flex items-center justify-center">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Our Training Team</h3>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-white/90">Expert Trainers</div>
            </div>
          </div>
        </motion.div>
