        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          {tiers.map((tier, index) => (
            <div
              ...
              className={`rounded-lg md:rounded-xl lg:rounded-2xl p-4 md:p-6 lg:p-8 transition-all duration-300 cursor-pointer ${tier.highlight
            ...
            >
              ...
              <div className="mb-4 flex items-baseline gap-2">
                <span className={`text-sm md:text-base font-medium ${tier.highlight ? 'text-blue-200' : 'text-gray-500'}`}>
                  GHS
                </span>
              ...
              <button
                onClick={() => navigate(`/projects/request?package=${tier.name.toLowerCase().replace(' ', '-')}`)}
                className={`w-full py-2 md:py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 text-sm md:text-base ${tier.highlight
