...
const PartnerTestimonials = () => {
  const testimonials = [
    {
      quote: "Zyra Tech Hub delivered a solution that perfectly fit our needs and exceeded our expectations.",
      author: "John Doe",
    ...
    {
      quote: "Working with Zyra Tech Hub has transformed how we deliver services to our community.",
